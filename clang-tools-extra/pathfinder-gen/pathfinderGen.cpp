...
public:
  ...
  bool VisitFunctionDecl(FunctionDecl *Declaration) {
    ...
    output.add("single_stage", function_group, function_name, torch_function.gen_fuzz_target(FTT_Basic));
  ...
  void extractModule(CXXRecordDecl* Declaration) {
    ...
    output.add("single_stage", module_group_name, module_name, torch_module.gen_fuzz_target(FTT_Basic));
  ...
  bool extractTensorMethod(CXXMethodDecl* method) {
    ...
    output.add("single_stage", tensor_method_group_name, method_name, torch_tensor_method.gen_fuzz_target(FTT_Basic));
